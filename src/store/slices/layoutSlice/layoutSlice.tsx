...
export const layoutSlice = createSlice({
  ...
  reducers: {
    ...
    toogleTheme: (state) => (state = { ...state, theme: toogleThemeReducer(state.theme) }),
  },
});
...
export const selectCurrentTheme = ({ layoutSlice }: RootState) => layoutSlice.theme;

export const selectThemeMode = ({ layoutSlice }: RootState) => getThemeMode(layoutSlice.theme);
