import { getBoardIndex, getColumnIndex, getTaskIndex } from 'store/slices/helpers/reducersHelpers';
...
export const getCurrentTaskName = (state: RootState) => {
  ...
  return state.kanbanSlice.data.boards[boardIndex].columns[columnIndex].tasks[taskIndex].title;
};
