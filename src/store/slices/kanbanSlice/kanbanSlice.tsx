...
export const kanbanSlice = createSlice({
  ...
  reducers: {
    ...
    columnChangeTaskDrag: (state, { payload }: PayloadAction<ColumnChangeDragType>) =>
...
export const selectCurrentTaskData = (state: RootState) => getCurrentTaskData(state);

export const selectCurrentBoard = (state: RootState) => state.kanbanSlice.currentBoardId;

export const selectCurrentBoardIndex = (state: RootState) =>
  state.kanbanSlice.data.boards.findIndex((board) => board.id === state.kanbanSlice.currentBoardId);
...
export const selectCurrentColumn = ({ kanbanSlice }: RootState) => kanbanSlice.currentColumnId;

export const selectCurrentTask = (state: RootState) => state.kanbanSlice.currentTaskId;

export const selectCurrentTaskName = (state: RootState) => getCurrentTaskName(state);
