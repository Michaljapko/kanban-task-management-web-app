...
const colors = {
  ...
  gradientLight: 'linear-gradient(180deg,#e9effa 0%,	rgba(233, 239, 250, 0.5) 100%)',
  gradientDark: 'linear-gradient(180deg, rgba(43, 44, 55, 0.25) 0%, rgba(43, 44, 55, 0.125) 100%);',
};
...
export const theme = {
  ...
  themeDark: {
    ...
    selectHover: colors.purpleLighter,
