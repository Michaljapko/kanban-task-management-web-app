...
import { STATUS, TASK_ADD, TASK_DESCRIPTION, TASK_EDIT, TASK_TITLE } from 'data/textEN';
...
const TaskEdit = () => {
  ...
  const currentColumnValue = taskColumnsData.find((column) => column.value === currentColumn);
