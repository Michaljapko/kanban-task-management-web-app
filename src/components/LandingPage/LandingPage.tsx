...
import { BoardAdd, BoardEdit, DeleteMenu, TaskAdd, TaskEdit } from 'components/ActionsMenus';
import {
  selectLayout,
  setIsBoardAddShow,
  setIsBoardEditShow,
...
const LandingPage = () => {
  ...
  const buttonHandler = () =>
    tasksData?.length === 0 ? dispatch(setIsBoardEditShow()) : dispatch(setIsBoardAddShow());
